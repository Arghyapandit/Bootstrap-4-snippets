...
- To use the bootstrap 4 snippets in AngularJs, Angular 2+ or in normal HTML file, just type `b4` followed by pressing `Ctrl+Space`. List will be appears. Check the belows shortcuts.
